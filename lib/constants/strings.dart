...
class Strings {
  ...
  static final List<String> aboutBullets = [firstAbout, secondAbout, thirdAbout, fourthAbout, fifthAbout, sixthAbout, seventhAbout, 
  eighthAbout, ninthAbout, tenthAbout, eleventhAbout, twelfthAbout];
}
